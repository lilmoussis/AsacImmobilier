...
<div class="deznav">
  <div>
      <ul class="metismenu" id="menu">
          <li>
              <a class=" ai-icon" href="{{route('admins.dashboard')}}" aria-expanded="false"><span class="nav-text">Dashboard</span>
              </a>
          </li>
          <li>
          ...
          <li>
              <a class=" ai-icon" href="{{route('admins.desistements.index')}}" aria-expanded="false"><span class="nav-text">Desistement</span>
              </a>
          </li>
          <li>
              <a class=" ai-icon" href="#" aria-expanded="false"><span class="nav-text">Vente</span>
              </a>
          </li>
          <li>
              <a class=" ai-icon" href="#" aria-expanded="false"><span class="nav-text">Proces Verbal</span>
              </a>
          </li>
      </ul>
  </div>
