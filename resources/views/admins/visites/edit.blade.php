...
@section('content')
    ...
    <form action="{{route('admins.visites.update',$id)}}" method="post">
        ...
        <input style="width: 50%; border-color: rgb(224, 152, 17) "  class="form-control" type="text" name="remarque" placeholder="remarque" value="{{$visites->$remarque}}" required><br>
        <input style="width: 50%; border-color: rgb(224, 152, 17) "  class="form-control" type="text" name="decision" placeholder="decision" value="{{$visites->$decision}}" required><br>
